...
$configureBox = <<-SCRIPT
    ...
    sudo apt-get update && sudo apt-get install -y docker-ce=$(sudo apt-cache madison docker-ce | grep 18.09 | head -1 | awk '{print $3}')
...
$configureMaster = <<-SCRIPT
    ...
    # kubectl apply --validate=false -f https://raw.githubusercontent.com/imilyukov/kubernetes-cluster/master/calico/rbac-kdd.yaml
    # kubectl apply --validate=false -f https://raw.githubusercontent.com/imilyukov/kubernetes-cluster/master/calico/calico.yaml
...
$configureNode = <<-SCRIPT
    ...
    sshpass -p "vagrant" scp -o StrictHostKeyChecking=no vagrant@192.168.205.10:/home/vagrant/.kube/config /home/vagrant/.kube
    sudo chown $(id -u vagrant):$(id -g vagrant) /home/vagrant/.kube/config
